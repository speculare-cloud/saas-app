	...
	<section class="flex flex-col sm:flex-row h-screen items-center text-white">
		...
		<div class="w-full lg:max-w-full md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
			<div class="w-full h-100">
				...
				<div class="alert shadow-lg bg-neutral text-sm" style="width: auto;">
					<div>
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="hidden sm:block stroke-info flex-shrink-0 w-6 h-6">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
						</svg>
						<div class="ml-1">
							<p>Magic Email service: stopped.</p>
							<p class="mt-2">
								You can still create your account to be informed when we'll open.
							</p>
						</div>
					</div>
				</div>
