		...
		<div class="mt-12 mb-12">
			...
			<div class="flex flex-col xl:flex-row xl:space-x-20 space-y-8 xl:space-y-0">
				<div class="flex-1 bg-base-300 rounded-lg shadow px-6 py-8">
					<button class="btn btn-md btn-info w-full" @click="testAlert()">
				...
				<div class="flex-2 prose-sm xl:flex flex-col justify-center align-middle">
			...
			<div class="max-w-lg mx-auto flex flex-col justify-center gap-6">
				...
				<button :disabled="!validated" class="btn btn-md btn-success" key="add_server">
...
export default {
	...
	computed: {
		validated() {
			return JSON.stringify(this.lastAlertTested) === JSON.stringify(this.alert);
		}
	},
